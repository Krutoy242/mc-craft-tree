...
const functionList = {
  ...
  'mekanism.infuser.addRecipe'                         : (infusionType: string,infusionConsumed: number,inputStack: any,outputStack: any) => $(outputStack, [BH('ore:'+ infusionType).amount(infusionConsumed/100), inputStack], BH('mekanism:machineblock:5').withTag({recipeType: 7})),

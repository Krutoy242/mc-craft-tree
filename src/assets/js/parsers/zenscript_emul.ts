...
class IngredientList {
  ...
  constructor(arg: any) {   
    ...
    this.keys = this.list.reduce((acc: { [x: string]: any }, i: { additionals: { index: any }; quantity: () => any }) => {
...
function addRecipe(_recipName: null, outputs: any, inputs: any, catalysts: any) {
...
const $ = (outputs: any, inputs: any, catalysts: any) => addRecipe(null, outputs, inputs, catalysts)


/*=====  EVAL functions ======*/
// eslint-disable-next-line no-unused-vars
export const recipes = {
  addShaped:    (recipName: any, output: any, input2d: any[]) => addRecipe(recipName, output, input2d, max(input2d.length, input2d.reduce((x: number,y: string | any[])=>max(x, y.length), 0)) > 2 ? [BH('minecraft:crafting_table')] : null),
  addShapeless: (recipName: any, output: any, input1d: string | any[]) => addRecipe(recipName, output, [input1d], input1d.length>4 ? [BH('minecraft:crafting_table')] : null)
}
// eslint-disable-next-line no-unused-vars
...
const functionList = {
  'botania.Apothecary.addRecipe'                     : (output: any, input1d: any)                      => addRecipe(null, output, [input1d, BH('minecraft:wheat_seeds')], catalysts('Apothecary')),
  'botania.Brew.addRecipe'                           : (input1d: any, brewName: string)                    => {[[BH('botania:vial:1'), BH('botania:brewflask')],[BH('botania:bloodpendant'), BH('botania:bloodpendant')],[BH('botania:vial'), BH('botania:brewvial')],[BH('botania:incensestick'), BH('botania:incensestick')]].forEach(pair=> {if(!(['botania:bloodpendant','botania:incensestick'].find(s=>s===pair[1].name)&& ['healing','absorption','overload','clear','warpWard'].find(s=>s===brewName))) addRecipe(null, pair[1].withTag({brewKey: brewName}), [pair[0], input1d], catalysts('Brew'))})},
  ...
  'botania.RuneAltar.addRecipe'                      : (output: any, input1d: any, mana: any)                => {const [runes, ingrs] = _.partition(input1d, ii=>ii.name.split(':')[1]==='rune'); addRecipe(null, output, [[BH('placeholder:Mana').amount(mana)], BH('botania:livingrock'), ...ingrs], [...catalysts('RuneAltar'), ...runes])},
  ...
  'extendedcrafting.CombinationCrafting.addRecipe'   : (output: any, rf: any, rf_t: any, central: any, ingrs: string | any[])     => addRecipe(null, output, [[central, BH('placeholder:RF').amount(rf)], ingrs], [BH('extendedcrafting:crafting_core'), BH('extendedcrafting:pedestal').amount(ingrs.length)]),
  'extendedcrafting.CompressionCrafting.addRecipe'   : (out: any, inp: { amount: (arg0: any) => any }, count: any, catalyst: any, rf: any, _rf_t: any) => addRecipe(null, out, [[inp?.amount(count), BH('placeholder:RF').amount(rf)]], [BH('extendedcrafting:compressor'), catalyst]),
  'extendedcrafting.EnderCrafting.addShaped'         : (out: any, input2d: { flat: () => { (): any; new(): any; length: any } })                         => addRecipe(null, out, input2d, [BH('extendedcrafting:ender_crafter'), BH('extendedcrafting:ender_alternator').amount(input2d.flat().length)]) ,
  ...
  'astralsorcery.Altar.addDiscoveryAltarRecipe'      : (name: any, out: any, n1: any, n2: any, ingr1d: any)            => addRecipe(name, out, [ingr1d], [BH('astralsorcery:blockaltar'), BH('placeholder:Starlight').amount(n1)]),
  'astralsorcery.Altar.addAttunementAltarRecipe'     : (name: any, out: any, n1: any, n2: any, ingr1d: any)            => addRecipe(name, out, [ingr1d], [BH('astralsorcery:blockaltar:1'), BH('placeholder:Starlight').amount(n1)]),
  'astralsorcery.Altar.addConstellationAltarRecipe'  : (name: any, out: any, n1: any, n2: any, ingr1d: any)            => addRecipe(name, out, [ingr1d], [BH('astralsorcery:blockaltar:2'), BH('placeholder:Starlight').amount(n1)]),
  'astralsorcery.Altar.addTraitAltarRecipe'          : (name: any, out: any, n1: any, n2: any, ingr1d: any, _name2: any)    => addRecipe(name, out, [ingr1d], [BH('astralsorcery:blockaltar:3'), BH('placeholder:Starlight').amount(n1)]),
  'astralsorcery.Grindstone.addRecipe'               : (input: any, out: any, _f1: any)                      => addRecipe(null, out, [[input]], [BH('astralsorcery:blockmachine:1')]) ,
  ...
  'astralsorcery.StarlightInfusion.addInfusion'      : (input: any, out: any, mult: any, chance: number, _time: any)      => addRecipe(null, out, [[input, BH('fluid:astralsorcery.liquidstarlight').amount(chance*1000)]], [BH('astralsorcery:blockstarlightinfuser')]) ,
  ...
  'actuallyadditions.Compost.addRecipe'                : (output: IIngredient, _1:any, input: IIngredient, _2:any) => $(output,input,BH('actuallyadditions:block_compost')),
  ...
  'bloodmagic.AlchemyTable.addRecipe'                  : (output: any,inputs: any,syphon: number,ticks: number,minTier: any)                      => $(output, [inputs, BH('placeholder:Life Essence').amount(syphon * ticks)], [BH('bloodmagic:alchemy_table'), BH('bloodmagic:blood_orb').withTag({orb: 'bloodmagic:' + ['weak', 'apprentice', 'magician', 'master', 'archmage'][(minTier||0)]})]),
  'bloodmagic.BloodAltar.addRecipe'                    : (output: any,input: any,minimumTier: any,syphon: any,_consumeRate: any,_drainRate: any) => $(output,[input, BH('placeholder:Life Essence').amount(syphon)], BH('placeholder:' + ['Blood Altar I', 'Blood Altar II', 'Blood Altar III', 'Blood Altar IV', 'Blood Altar V'][minimumTier||0])),
  ...
  'mekanism.chemical.dissolution.addRecipe'            : (inputStack: any,outputGas: any)                                 => $(outputGas, inputStack, BH('mekanism:machineblock2:6')),
  ...
  'mekanism.compressor.addRecipe'                      : (inputStack: any, /* inputGas,  */outputStack: any)              => $(outputStack, inputStack, BH('mekanism:machineblock:1')),
  'mekanism.crusher.addRecipe'                         : (inputStack: any,outputStack: any)                               => $(outputStack, inputStack, BH('mekanism:machineblock:3')),
  'mekanism.enrichment.addRecipe'                      : (inputStack: any,outputStack: any)                               => $(outputStack, inputStack, BH('mekanism:machineblock')),
  'mekanism.infuser.addRecipe'                         : (infusionType: string,infusionConsumed: number,inputStack: any,outputStack: any) => $(outputStack, [BH('ore:'+ infusionType[0].toUpperCase() + infusionType.slice(1).toLowerCase()).amount(infusionConsumed/100), inputStack], BH('mekanism:machineblock:5').withTag({recipeType: 7})),

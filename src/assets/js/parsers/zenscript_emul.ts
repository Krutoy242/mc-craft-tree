...
const functionList = {
  ...
  'bloodmagic.AlchemyTable.addRecipe'                  : (output: any,inputs: any,syphon: number,ticks: number,minTier: any)                      => $(output, [inputs, BH('placeholder:Life Essence').amount(syphon * ticks)], ['bloodmagic:alchemy_table', BH('bloodmagic:blood_orb').withTag({orb: 'bloodmagic:' + ['weak', 'apprentice', 'magician', 'master', 'archmage'][(minTier||0)]})]),
